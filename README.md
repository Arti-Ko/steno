...
Steno сам проверяет [GitHub Releases](https://github.com/Arti-Ko/steno/releases) при запуске и каждые 6 часов. Новая версия скачивается в фоне и ставится, когда вы закрываете Steno, — работа не прерывается. Чтобы обновиться сразу, нажмите «Перезапустить для версии X» внизу боковой панели.

Если в **Настройки → Обновления** выключить «Устанавливать обновления автоматически», вместо этого появится окно с описанием изменений и кнопкой «Установить». Проверить вручную — **Steno → Проверить обновления…**.
